...
public class Main1 {
    public static void medical()
    {
        ...
        ph.accept_customer("Ananya", "B3- Silver Township,Amrithapuri",2, "8983282880");
        ph.accept_customer("Esha", "401, KB Society, Kollam",3, "7517362175");
        ph.accept_customer("Prerana", "22, Greenland County,Thiruvalla",5, "8345267906");
        ph.accept_customer("likith","125,Gandhi nager,cohin",6,"9550793200");
        ph.accept_customer("Anupa","14/123,near bandhar roadway,Valiyavila",7,"9876543210");
        ph.accept_customer("Ashok kumar","25/102,Beside of the Golden banks ,Trivandarn",10,"9587410236");
